...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-126954833-24"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-126954833-24');
</script>
...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Apple サポート ヘルプラインに問い合わせる:</p>
...
<div id="nbdnsbndbew">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> MacOSX セキュリティ センター</span>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Apple サポート ヘルプラインに問い合わせる: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpg" class="img-fluid">
    ...
    position: absolute;
    bottom: 46px;
    left: 42px;">Apple サポートに電話する: <strong>
...
<!--start sticky footer-->
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Apple サポートに問い合わせる: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
